# Проект «Кекстаграм» курса «Фронтенд-разработчик + JavaScript-разработчик. LITE #2» HTML Academia
...
5.3. При переключении фильтров, отрисовка изображений, подходящих под новый фильтр, должна производиться не чаще, чем один раз в 500 мс (устранение дребезга).
